...
class VisualizationWindow(QMainWindow):
    ...
    def __init__(self, master_window: MasterWindow, all_visualization, n):
        ...
        """
        super().__init__()
        self.ui = uic.loadUi("/Users/Alicia/PycharmProjects/3drekonstruktionspeiseroehre/3drekonstruktionspeiseroehre/ui-files/visualization_window_design.ui", self)
