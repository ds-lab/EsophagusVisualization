...
class EndoscopySelectionWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, master_window: MasterWindow, visualization_data: VisualizationData):
        ...
        """
        super().__init__()
        self.ui = uic.loadUi("/Users/Alicia/PycharmProjects/3drekonstruktionspeiseroehre/3drekonstruktionspeiseroehre/ui-files/endoscopy_selection_window_design.ui", self)
