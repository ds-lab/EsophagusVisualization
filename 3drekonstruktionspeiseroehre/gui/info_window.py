...
class InfoWindow(QDialog):
    ...
    def __init__(self):
        ...
        """
        super().__init__()
        self.ui = uic.loadUi(r'C:\Users\piasc\Documents\Studium\Projekt-Achalasie\3drekonstruktionspeiseroehre\3drekonstruktionspeiseroehre\ui-files\info_window_design.ui', self)
