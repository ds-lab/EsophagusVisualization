...
class PositionSelectionWindow(QMainWindow):
    ...
    def __init__(self, master_window: MasterWindow, visualization, next_window, all_visualization, n):
        ...
        super().__init__()
        self.ui = uic.loadUi("/Users/Alicia/PycharmProjects/3drekonstruktionspeiseroehre_flex/3drekonstruktionspeiseroehre/ui-files/position_selection_window_design.ui", self)
