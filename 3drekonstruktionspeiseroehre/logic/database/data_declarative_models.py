...
class ManometryFile(Base):
    ...
    pressure_matrix_shape_0 = mapped_column(Integer, nullable=False), # number of sensors
    pressure_matrix_shape_1 = mapped_column(Integer, nullable=False) # number of measurements
